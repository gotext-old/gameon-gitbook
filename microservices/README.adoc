...
The configuration attributes stored in etcd are environment-specific: different values are provided for different deployment stages. In our configuration, etcd is not used for local development.
