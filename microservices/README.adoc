...
Having this as a separate entity allows our front-end to be changed and updated independently from other services. This service has fairly simple scaling requirements, as it serving only cachable static files.
